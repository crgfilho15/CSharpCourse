...
namespace CursoCSharp.Api
{
    class ExemploTimeSpan
    {
        public static void Executar()
        {
            ...
            Console.WriteLine(intervalo.Add(TimeSpan.FromMinutes(8))); // Gera um novo TimeSpan, não mexe no original
            Console.WriteLine(intervalo); // original
            Console.WriteLine(intervalo.Subtract(TimeSpan.FromMinutes(8))); // Gera um novo TimeSpan, não mexe no original
